...
- **Solo Founder** at soul.rentedsouls.com: Built and scaled an enterprise AI digital persona platform utilizing advanced video generation (WAN 2.5 I2V, Seedream, Nano Banana) and TTS architectures (Kokoro).
...
- **Jr. Python Developer (Applied AI/ML)** at Thinkbiz Technology Private Limited (May 2024 - March 2025): Developed 'Jugaad', an advanced OCR and LLM pipeline for processing text from invoices.
