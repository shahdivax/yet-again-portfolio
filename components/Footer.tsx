...
return (
<footer id="contact" className={`w-full py-12 md:py-8 overflow-hidden relative border-t ${isDark ? "bg-[#0a0a0a] text-white border-[#262626]" : "bg-[var(--background)] text-black border-[var(--border)]"}`}>
<div className={`max-w-[1400px] mx-auto px-6 sm:px-12 flex flex-col justify-between items-start border-b pb-10 relative z-10 ${isDark ? "border-[#262626]" : "border-[var(--border)]"}`}>
<motion.div
...
<h2 className={`text-4xl md:text-6xl font-bold tracking-tighter uppercase leading-[0.85] transition-colors duration-700 ${isDark ? "text-white brutalist-outline" : "text-black editorial-text"}`}>
LET'S
<br />
...
<div className={`w-full mt-6 flex flex-col md:flex-row justify-between items-start md:items-end gap-12 font-mono uppercase text-sm tracking-widest ${isDark ? "text-zinc-500" : "text-[var(--muted)]"}`}>
